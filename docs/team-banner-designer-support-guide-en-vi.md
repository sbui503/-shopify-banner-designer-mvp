...
1. Main editor with product loaded
   ![Main editor with product loaded](support-guide-images/01-main-editor-product-loaded.png)

2. Templates panel and bulk generator
   ![Templates and bulk generator](support-guide-images/02-templates-and-bulk-generator.png)

3. Photo Frame generator
   ![Photo frame generator](support-guide-images/03-photo-frame-generator.png)

4. Assets library
   ![Assets library](support-guide-images/04-assets-library.png)

5. Properties panel
   ![Properties panel](support-guide-images/05-properties-panel.png)

6. Mobile Canva-style ruler
   ![Mobile Canva-style ruler](support-guide-images/06-mobile-canva-style-ruler.png)

7. Mobile text and color editing
   ![Mobile text and color editing](support-guide-images/07-mobile-text-and-color-editing.png)
